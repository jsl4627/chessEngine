...
* 
* This component is an Information Expert on chess game moves. 
*/ 
	...
	*/ 
	function Move(start, end) { 
		...
		if(!end instanceof Position) { 
			throw new Error('end (' + end + ') isd not a Position.'); 
		} 
		// 
		this.start = start; 
		this.end = end; 
	...
	/** 
	* Create a Move object that is the reverse of this move. 
	*/ 
